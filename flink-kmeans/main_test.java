...
public class KMeans {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 输出每次迭代的次数
        iterativeCentroids.map(new MapFunction<Centroid, Centroid>() {
            @Override
            public Centroid map(Centroid centroid) throws Exception {
                System.out.println("Iteration number: " + (iterations - iterativeCentroids.getIterationCount())); // 输出当前迭代次数
                return centroid;
            }
        });
